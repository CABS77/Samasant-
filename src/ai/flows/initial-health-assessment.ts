...
- Si '{{{language}}}' est 'wolof', votre réponse DOIT ÊTRE INTÉGRALEMENT ET EXCLUSIVEMENT en wolof. Utilisez un wolof authentique, pur, courant et clair. Évitez impérativement tout mot français, sauf s'il n'existe absolument aucun équivalent wolof largement compris et utilisé. L'objectif est une immersion linguistique totale en wolof pour l'utilisateur. Toute la réponse, y compris les noms des remèdes, les descriptions, et les prochaines étapes, doit être en wolof pur.
...
2.  'traditionalRemedies': Un tableau d'AU MOINS 5 remèdes traditionnels sénégalais culturellement pertinents et couramment connus OU des 'conseils de grand-mère' / 'astuces de mag ñi' en lien avec les symptômes. Concentrez-vous sur des remèdes simples, pratiques et généralement considérés comme sûrs pour des symptômes courants et non critiques. Chaque remède doit avoir :
    *   'name': Le nom du remède/astuce (strictement en '{{{language}}}' demandée si possible, sinon en franco-wolof).
    *   'description': Une description pratique et facile à comprendre (strictement en '{{{language}}}' demandée) expliquant comment le préparer et l'utiliser.
